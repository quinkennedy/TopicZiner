...
public class FormattedTextBlock{
 ...
 // private ArrayList<Rectangle> blockedOut = new ArrayList<Rectangle>();
  ...
  public void add(String text, FontFamily.FontWeight _fontWeight, FontFamily.FontEm _fontEm, float _fontSize){
    add(new FormattedText(text, _fontWeight, _fontEm, _fontSize));
  }
  ...
  public static class FormattedText{
    ...
    FontFamily.FontEm fontEm;
    float startX, startY;
    
    public FormattedText(String text, PFont font){
      init(text, FontFamily.FontWeight.REGULAR, FontFamily.FontEm.REGULAR, font, font.getSize());
    }
    
    public FormattedText(String text, FontFamily.FontWeight _fontWeight, FontFamily.FontEm _fontEm, float _fontSize){
      init(text, _fontWeight, _fontEm, null, _fontSize);
    }
    
    public FormattedText(String text, PFont font, float fontSize){
      init(text, FontFamily.FontWeight.REGULAR, FontFamily.FontEm.REGULAR, font, fontSize);
    }
    
    private void init(String _text, FontFamily.FontWeight _fontWeight, FontFamily.FontEm _fontEm, PFont _font, float _fontSize){
      this.text = _text;
      this.font = _font;
